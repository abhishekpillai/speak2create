...
![](../images/realtime_prompting_guide.png)
...
- [Realtime Prompting Guide](#realtime-prompting-guide)
  - [Table of Contents](#table-of-contents)
    - [Example (model takes on a specific accent)](#example-model-takes-on-a-specific-accent)
    - [Example (model takes on a character)](#example-model-takes-on-a-character)
    - [Example](#example)
    - [Example (multi-emotion)](#example-multi-emotion)
    - [Example](#example-1)
    - [Example (pinning to one language)](#example-pinning-to-one-language)
    - [Example (model teaches a language)](#example-model-teaches-a-language)
    - [Example](#example-2)
    - [Example](#example-3)
    - [Example (general instruction section)](#example-general-instruction-section)
    - [Example (instruction in conversation state)](#example-instruction-in-conversation-state)
    - [**Instructions Quality Prompt (can be used in ChatGPT or with API)**](#instructions-quality-prompt-can-be-used-in-chatgpt-or-with-api)
    - [**Prompt Optimization Meta Prompt (can be used in ChatGPT or with API)**](#prompt-optimization-meta-prompt-can-be-used-in-chatgpt-or-with-api)
    - [Example (coughing and unclear audio)](#example-coughing-and-unclear-audio)
    - [Example](#example-4)
    - [Example](#example-5)
...
![](../images/repeat_before.png)

This is the responses **after** applying the instruction using `gpt-realtime`

![](../images/repeat_after.png)
